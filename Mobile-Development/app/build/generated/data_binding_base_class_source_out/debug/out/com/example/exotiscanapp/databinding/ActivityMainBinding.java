...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull FloatingActionButton fab, @NonNull FrameLayout frameDashboard) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.frame_dashboard;
      FrameLayout frameDashboard = ViewBindings.findChildViewById(rootView, id);
      if (frameDashboard == null) {
        break missingId;
      }
